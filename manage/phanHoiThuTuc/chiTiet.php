...
if (isset($_SESSION['LoginOK'])) {
    ...
    if(isset($_GET['type']) && isset($_GET['id'])){
        ...
        $id = $_GET['id'];
        if($type == 'tamtru') {
            $result = $ps->getChiTietTamTru($id);
        }
        else {
            $result = $ps->getChiTietTamVang($id);
        }
        $row = $result;
?>
    <main id="content" style="background-color:#f0f0f0;">
        <div class="container">
            <div class="row">
                <form action="process-pheDuyet.php" method="POST" class="form mt-5 ps-5 pe-5 pt-5 pb-5 container" id="form-2">
